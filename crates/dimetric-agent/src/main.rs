...
//!
//! Two front-ends were planned over one command layer: this CLI and an MCP
//! server. Both are clients of [`dimetric_host::Command`], exactly as the GUI
//! editor is (invariant I1). Nothing here reaches past the bus.
